...
const data = [
  {
    ...
    title: "Clean",
    description:
      "Vehicles in good condition, with no damage, and not involved in accidents or insurance claims.",
  },
  {
    image: image2,
    title: "Repossessed",
    description:
      "Vehicles with damage requiring repairs (accidents, fires, floods, and other incidents)",
  },
  {
    image: image3,
    title: "Recovered",
    description:
      "Vehicles that were stolen and later recovered by owners or insurance companies.",
  },
  {
    image: image4,
    title: "Fleet",
    description:
      "Vehicles previously used by corporate clients or in rental programs.",
  },
  {
    image: image1,
    title: "Lease",
